                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.siswa.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="jumlah_siswa" name="jumlah_siswa" value="{{ old('jumlah_siswa') }}" required>
                            </div>
                            
                            <div class="mb-3">
                                <label for="jumlah_siswa_l" class="form-label">Jumlah Siswa Laki-laki</label>
                                <input type="number" class="form-control" id="jumlah_siswa_l" name="jumlah_siswa_l" value="{{ old('jumlah_siswa_l') }}" required>
                            </div>
                            
                            <div class="mb-3">
                                <label for="jumlah_siswa_p" class="form-label">Jumlah Siswa Perempuan</label>
                                <input type="number" class="form-control" id="jumlah_siswa_p" name="jumlah_siswa_p" value="{{ old('jumlah_siswa_p') }}" required>
                            </div>
