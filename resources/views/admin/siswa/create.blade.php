...
<div class="container mt-4">
    ...
    <form action="{{ route('admin.siswa.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="number" name="jumlah_siswa_l" id="jumlah_siswa_l" class="form-control" value="{{ old('jumlah_siswa_l') }}" required>
        </div>

        <div class="form-group">
            <label for="jumlah_siswa_p">Jumlah Siswa Perempuan</label>
            <input type="number" name="jumlah_siswa_p" id="jumlah_siswa_p" class="form-control" value="{{ old('jumlah_siswa_p') }}" required>
        </div>

        <div class="form-group">
            <label for="jumlah_siswa">Total Jumlah Siswa</label>
            <input type="number" name="jumlah_siswa" id="jumlah_siswa" class="form-control" value="{{ old('jumlah_siswa') }}" readonly required>
        </div>
