...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Edit Kelas Siswa</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('siswa.update', $siswa->id_siswa) }}">
                            ...
                            <div class="col-md-6">
                                <select id="id_admin" class="form-control @error('id_admin') is-invalid @enderror" name="id_admin" required>
                                    ...
                                    @foreach ($admins as $admin)
                                        <option value="{{ $admin->id_admin }}" {{ $siswa->id_admin == $admin->id_admin ? 'selected' : '' }}>
                                            {{ $admin->username }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="nama_kelas" type="text" class="form-control @error('nama_kelas') is-invalid @enderror" name="nama_kelas" value="{{ old('nama_kelas', $siswa->nama_kelas) }}" required>
                                @error('nama_kelas')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <select id="wali_kelas" class="form-control @error('wali_kelas') is-invalid @enderror" name="wali_kelas" required>
                                    ...
                                    @foreach ($guru as $g)
                                        <option value="{{ $g->nama }}" {{ $siswa->wali_kelas == $g->nama ? 'selected' : '' }}>
                                            {{ $g->nama }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="jumlah_siswa" type="number" class="form-control @error('jumlah_siswa') is-invalid @enderror" name="jumlah_siswa" value="{{ old('jumlah_siswa', $siswa->jumlah_siswa) }}" required min="0">
                                @error('jumlah_siswa')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="jumlah_siswa_l" type="number" class="form-control @error('jumlah_siswa_l') is-invalid @enderror" name="jumlah_siswa_l" value="{{ old('jumlah_siswa_l', $siswa->jumlah_siswa_l) }}" required min="0">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="jumlah_siswa_p" type="number" class="form-control @error('jumlah_siswa_p') is-invalid @enderror" name="jumlah_siswa_p" value="{{ old('jumlah_siswa_p', $siswa->jumlah_siswa_p) }}" required min="0">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="tahun" type="number" class="form-control @error('tahun') is-invalid @enderror" name="tahun" value="{{ old('tahun', $siswa->tahun) }}" required min="2000" max="2100">
                                @error('tahun')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea id="history" class="form-control @error('history') is-invalid @enderror" name="history" rows="4">{{ old('history', $siswa->history) }}</textarea>
                                @error('history')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
