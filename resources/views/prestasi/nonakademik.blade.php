...
<div class="container my-5">
    <div class="page-header">
        <h1 class="mb-2"><i class="fa fa-trophy"></i> Prestasi Non-Akademik</h1>
        <p class="lead">Menampilkan berbagai pencapaian luar biasa dari siswa-siswi kami di luar bidang akademik.</p>
    </div>

    <div class="highlight-box">
        <h5><i class="fa fa-star text-warning"></i> Highlight Prestasi Non-Akademik</h5>
        <p>SMP N2 Siborongborong juga berkomitmen untuk memfasilitasi pengembangan bakat dan minat siswa di luar bidang akademik, seperti olahraga, seni, dan kegiatan ekstrakurikuler lainnya. Prestasi-prestasi ini menunjukkan keberagaman talenta siswa kami yang luar biasa.</p>
    </div>
